...
{\vskip -0.3em}
\ind \hspace{0.35in} \footnotesize Thesis: \href{https://arxiv.org/abs/1602.02383}{\emph{Disentangled Representations in Neural Models}}.\normalsize
...
\ind William F. Whitney and Rob Fergus. Disentangling video with independent prediction. In \emph{Learning Disentangled Representations: from Perception to Control} at NIPS'17. 2017.


\ind Mikael Henaff, William F. Whitney, and Yann LeCun. Model-based planning in discrete action spaces. \emph{arXiv preprint arXiv:1705.07177}, 2017.


\ind Vlad Firoiu, William F. Whitney, and Joshua B. Tenenbaum. Beating the world’s best at Super Smash Bros. with deep reinforcement learning. \emph{arXiv preprint arXiv:1702.06230}, 2017.


\ind William F. Whitney, Michael Chang, Tejas Kulkarni, and Joshua B. Tenenbaum. Understanding visual concepts with continuation learning. In \emph{International Conference on Learning Representations, Workshop Track}, 2016.


\ind William F. Whitney. Disentangled Representations in Neural Models. Master's thesis, Massachusetts Institute of Technology, 2016.


\ind Tejas D. Kulkarni*, William F. Whitney*, Pushmeet Kohli, and Joshua B. Tenenbaum. Deep convolutional inverse graphics network. In \emph{Advances in Neural Information Processing Systems}, pages 2539–2547, 2015.
...
{\vskip -0.3em}
\ind \hspace{0.35in} \footnotesize Downloaded >270,000 times and now maintained by an open-source team. \normalsize
